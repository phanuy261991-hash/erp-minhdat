...
Sẽ tự chuyển đến trang đăng nhập. Đăng nhập bằng tài khoản demo ở mục 4, sẽ được chuyển sang trang **Tổng quan** (dashboard) với sidebar điều hướng bên trái. Đăng nhập bằng `admin` sẽ thấy đủ menu, gồm nhóm "Kho" (Sản phẩm, Nhập kho, Xuất kho — Phase 2, đã xong đầy đủ), nhóm "Nhà cung cấp" (Nhà cung cấp, Công nợ NCC — Phase 3, đã xong), nhóm "Khách hàng" (Khách hàng, Công nợ khách hàng — tách riêng 2026-08-01), nhóm "Quản trị" (Người dùng, Vai trò) và nhóm "Cấu hình" (Thông tin công ty, Cấu hình kho — gồm cả chọn phương pháp tính giá vốn, Loại khách hàng, Cấu hình bán hàng — khung trống chưa có nội dung); đăng nhập bằng `thukho1` (quyền module `kho`) sẽ thấy "Tổng quan" + nhóm "Kho" (Sản phẩm, Nhập kho, Xuất kho), nhưng không thấy nhóm "Nhà cung cấp"/"Khách hàng"/"Người dùng"/"Vai trò"/"Cấu hình" — đúng theo phân quyền (chặn cả ở giao diện lẫn API, thử vào thẳng URL các trang trên cũng bị chuyển hướng về Tổng quan).
